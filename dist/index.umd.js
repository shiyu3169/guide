(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.byteGuide = {}, global.React, global.ReactDOM));
  ...
  var Modal = function Modal(_ref) {
    ...
    var focusedElRef = React.useRef(null);
    /* the index of the focused element in the NodeList `focusableEls` */
    var focusedIdxRef = React.useRef(0);
    var _useState = React.useState({}),
      _useState2 = _slicedToArray(_useState, 2),
    ...
    return visible ? /*#__PURE__*/ReactDOM__default['default'].createPortal( /*#__PURE__*/React__default['default'].createElement("div", {
      ref: modalRef,
      ...
      style: arrowStyle
    }), hotspot && /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-hotspot"),
      style: hotspotStyle
    }), closeEle ? /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-close-icon"),
      onClick: onClose
    }, closeEle) : closable ? /*#__PURE__*/React__default['default'].createElement(CloseSmall, {
      className: "".concat(PREFIX, "-close-icon"),
      onClick: onClose
    }) : null, /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-title")
    }, stepInfo.title), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-content")
    }, typeof stepInfo.content === 'function' ? stepInfo.content() : stepInfo.content), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-footer")
    }, /*#__PURE__*/React__default['default'].createElement("span", {
      className: "".concat(PREFIX, "-footer-text")
    }, _stepText(stepIndex + 1, steps.length)), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "".concat(PREFIX, "-footer-btn-group")
    }, showSkipBtn && stepIndex != steps.length - 1 && /*#__PURE__*/React__default['default'].createElement("button", {
      className: "".concat(PREFIX, "-footer-btn ").concat(PREFIX, "-footer-skip-btn"),
      onClick: onClose
    }, String(_skipText)), showPreviousBtn && stepIndex !== 0 && /*#__PURE__*/React__default['default'].createElement("button", {
      className: "".concat(PREFIX, "-footer-btn ").concat(PREFIX, "-footer-prev-btn"),
      onClick: handlePreviousChange
    }, String(_prevText)), /*#__PURE__*/React__default['default'].createElement("button", {
  ...
  var Guide = function Guide(props) {
    ...
    var i18nTEXT = React.useMemo(function () {
      return i18n(lang);
    }, [lang]);
    ...
    var parentEl = React.useMemo(function () {
     ...
     */
    var realWindow = React.useMemo(function () {
      return anchorEl ? getWindow(anchorEl) : null;
    }, [anchorEl]);
    var realDocument = React.useMemo(function () {
    ...
    return (!mask || initOverflowVal) && parentEl ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, mask && /*#__PURE__*/React__default['default'].createElement(Mask, {
  ...
  exports.CUSTOM_ELEMENT_CLASS = CUSTOM_ELEMENT_CLASS;
