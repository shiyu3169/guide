...
export declare const getContainingBlock: (node: Element, callback?: ((node: Element | null) => unknown) | undefined) => (Node & ParentNode) | null;
 ...
 */
export declare const getOffsetParent: (node: Element | HTMLElement, callback?: ((node: Element | null) => unknown) | undefined) => Element | (Node & ParentNode) | (Window & typeof globalThis) | null;
